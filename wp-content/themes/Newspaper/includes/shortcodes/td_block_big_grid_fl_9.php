...
class td_block_big_grid_fl_9 extends td_block {
    ...
    static function cssMedia( $res_ctx ) {
        ...
        // module mx26 fonts
        $res_ctx->load_font_settings( 'mx26f_title' );
        $res_ctx->load_font_settings( 'mx26f_cat' );
        // module mx25 fonts
    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
                ...
                /* @mx26f_title */
				.$unique_block_class .td_block_inner .td_module_mx26 .td-big-grid-meta .entry-title {
					@mx26f_title
				}
				/* @mx26f_cat */
				.$unique_block_class .td_module_mx26 .td-post-category {
					@mx26f_cat
				}
                /* @mx25f_title */
        ...
        if (!empty($posts)) {
            ...
            if ($td_column_number==1 || $td_column_number==2) {
                ...
                foreach ($posts as $post) {
                    ...
                    if ($post_count == 1) {
                        $td_module_mx26 = new td_module_mx26($post, $this->get_all_atts());
