...
class td_block_big_grid_fl_6 extends td_block {
    ...
    static function cssMedia( $res_ctx ) {
        ...
        // module mx22 fonts
        $res_ctx->load_font_settings( 'mx22f_title' );
        $res_ctx->load_font_settings( 'mx22f_cat' );
        $res_ctx->load_font_settings( 'mx22f_meta' );
    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
                ...
                /* @mx22f_title */
				.$unique_block_class .td_block_inner .td-big-grid-scroll .td_module_mx22 .entry-title {
					@mx22f_title
				}
				/* @mx22f_cat */
				.$unique_block_class .td_module_mx22 .td-post-category {
					@mx22f_cat
				}
				/* @mx22f_meta */
				.$unique_block_class .td_module_mx22 .td-module-meta-info {
					@mx22f_meta
				}
        ...
        if (!empty($posts)) {
            ...
            if ($td_column_number==1 || $td_column_number==2) {
                ...
                foreach ($posts as $post) {
                    ...
                    $td_module_mx22 = new td_module_mx22($post, $this->get_all_atts());
